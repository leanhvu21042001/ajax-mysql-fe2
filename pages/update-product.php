...
if(!empty($_POST['productName']) && !empty($_POST['productDescription']) && !empty($_POST['productPrice']) && !empty($_POST['productPhoto'])) {
    ...
    if($productModel->updateProduct($productName, $productDescription, $productPrice, $productPhoto, $id)) {
        ...
        header('Location: http://localhost/hoc-php-ajax-mysql-front-end-2/pages/manage-products.php');
    }
    ...
    <div class="container">
        ...
        <form action="update-product.php?id=<?php echo $id; ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="productPhoto" id="productPhoto" class="form-control" placeholder="Product photo" aria-describedby="helpId" value="<?php echo $item['product_photo']; ?>">
            </div>
